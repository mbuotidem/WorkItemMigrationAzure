...
//            builder.AddUserSecrets<MoveWorkItemToProject>();
...
//                string sourceTeamProject = "PeerTutor.us", destinationTeamProject = "interro.us"; //Replace the team projects names here with the names of your own projects

//                string queryPath = "Shared Queries/MoveMe"; //Replace this string with the path to your own query. Learn about queries here: https://docs.microsoft.com/en-us/azure/devops/boards/queries/?view=azure-devops
